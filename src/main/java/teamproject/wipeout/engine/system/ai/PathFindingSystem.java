...
public class PathFindingSystem {
    ...
    public static List<Point2D> findStringPullPath(Point2D startPoint, Point2D endPoint, List<NavigationSquare> squarePath) {
        findStringPullPath(startPoint, endPoint, squarePath, 0);
    }
